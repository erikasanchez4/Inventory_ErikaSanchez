...
namespace Inventory_ErikaSanchez {
    ...
    public partial class InventoryDataSet : global::System.Data.DataSet {
        ...
        public partial class InventoryDataTable : global::System.Data.TypedTableBase<InventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public InventoryRow AddInventoryRow(string ProductName, string Category, decimal Price, int QtyInStock) {
...
namespace Inventory_ErikaSanchez.InventoryDataSetTableAdapters {
    ...
    public partial class InventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Inventory] WHERE (([ProductId] = @Original_ProductId) AND ([Pr" +
                "oductName] = @Original_ProductName) AND ([Category] = @Original_Category) AND ([" +
                "Price] = @Original_Price) AND ([QtyInStock] = @Original_QtyInStock))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Inventory] ([ProductName], [Category], [Price], [QtyInStock]) " +
                "VALUES (@ProductName, @Category, @Price, @QtyInStock);\r\nSELECT ProductId, Produc" +
                "tName, Category, Price, QtyInStock FROM Inventory WHERE (ProductId = SCOPE_IDENT" +
                "ITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Inventory] SET [ProductName] = @ProductName, [Category] = @Category, [Price] = @Price, [QtyInStock] = @QtyInStock WHERE (([ProductId] = @Original_ProductId) AND ([ProductName] = @Original_ProductName) AND ([Category] = @Original_Category) AND ([Price] = @Original_Price) AND ([QtyInStock] = @Original_QtyInStock));
SELECT ProductId, ProductName, Category, Price, QtyInStock FROM Inventory WHERE (ProductId = @ProductId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Inventory_ErikaSanchez.Properties.Settings.Default.InventoryConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, ProductName, Category, Price, QtyInStock FROM dbo.Inventory";
        ...
        public virtual int Delete(int Original_ProductId, string Original_ProductName, string Original_Category, decimal Original_Price, int Original_QtyInStock) {
        ...
        public virtual int Insert(string ProductName, string Category, decimal Price, int QtyInStock) {
            if ((ProductName == null)) {
        ...
        public virtual int Update(string ProductName, string Category, decimal Price, int QtyInStock, int Original_ProductId, string Original_ProductName, string Original_Category, decimal Original_Price, int Original_QtyInStock, int ProductId) {
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string Category, decimal Price, int QtyInStock, int Original_ProductId, string Original_ProductName, string Original_Category, decimal Original_Price, int Original_QtyInStock) {
            return this.Update(ProductName, Category, Price, QtyInStock, Original_ProductId, Original_ProductName, Original_Category, Original_Price, Original_QtyInStock, Original_ProductId);
        }
    }
